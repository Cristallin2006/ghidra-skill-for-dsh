...
TOOL_REGISTRY = [
    ...
    _Tool(name="tshark", tier="C", kind="path",
          path=r"C:\Program Files\Wireshark\tshark.exe",
          refs="traffic-analysis（协议分层统计/--export-objects/editcap 转换；无它走 pcap_triage.py 保底）",
          hint="Wireshark 安装包勾选 TShark 组件（editcap/tcpdump 随附）"),
